...
namespace merissu
{
    public class CompProperties_YinYangRotatingGraphicPurple : CompProperties
    {
        public CompProperties_YinYangRotatingGraphicPurple()
        {
            this.compClass = typeof(Comp_YinYangRotatingGraphicPurple);
        }
    }
    public class Comp_YinYangRotatingGraphicPurple : ThingComp
    {
        ...
        {
            matLayer0 = MaterialPool.MatFrom("Pawn/YinYangJade/Purple0", ShaderDatabase.Mote);
            matLayer1 = MaterialPool.MatFrom("Pawn/YinYangJade/Purple1", ShaderDatabase.MoteGlow);
            matLayer2 = MaterialPool.MatFrom("Pawn/YinYangJade/Purple2", ShaderDatabase.MoteGlow);
            matLayer3 = MaterialPool.MatFrom("Pawn/YinYangJade/Purple3", ShaderDatabase.MoteGlow);
        }
    }
}