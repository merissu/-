...
namespace merissu
{
    public class CompProperties_YinYangRotatingGraphicgreen : CompProperties
    {
        public CompProperties_YinYangRotatingGraphicgreen()
        {
            this.compClass = typeof(Comp_YinYangRotatingGraphicgreen);
        }
    }
    public class Comp_YinYangRotatingGraphicgreen : ThingComp
    {
        ...
        {
            matLayer0 = MaterialPool.MatFrom("Pawn/YinYangJade/green0", ShaderDatabase.Mote);
            matLayer1 = MaterialPool.MatFrom("Pawn/YinYangJade/green1", ShaderDatabase.MoteGlow);
            matLayer2 = MaterialPool.MatFrom("Pawn/YinYangJade/green2", ShaderDatabase.MoteGlow);
            matLayer3 = MaterialPool.MatFrom("Pawn/YinYangJade/green3", ShaderDatabase.MoteGlow);
        }
    }
}