...
namespace merissu
{
    public class CompProperties_YinYangRotatingGraphic : CompProperties
    {
        public CompProperties_YinYangRotatingGraphic()
        {
            this.compClass = typeof(Comp_YinYangRotatingGraphic);
        }
    }
    public class Comp_YinYangRotatingGraphic : ThingComp
    {
        ...
        {
            matLayer0 = MaterialPool.MatFrom("Pawn/YinYangJade/red0", ShaderDatabase.Mote);
            matLayer1 = MaterialPool.MatFrom("Pawn/YinYangJade/red1", ShaderDatabase.MoteGlow);
            matLayer2 = MaterialPool.MatFrom("Pawn/YinYangJade/red2", ShaderDatabase.MoteGlow);
            matLayer3 = MaterialPool.MatFrom("Pawn/YinYangJade/red3", ShaderDatabase.MoteGlow);
        }
    }
}