...
namespace merissu
{
    public class AttackMode_GoheiDelayedOrbitSpread : GoheiAttackMode
    {
        public override string ModeName => "GoheiDelayedOrbitSpread";
        protected override string ProjectileDefName => "REIMU_SpreadTalisman"; 
        ...
        private const int RealProjectilePerFake = 6;
        ...
        public override bool OverrideCastShot(Verb_GoheiRandomShoot verb, LocalTargetInfo target)
        {
            ...
            for (int i = 0; i < FakeProjectileCount; i++)
            {
                ...
                ThingDef moteDef = ThingDef.Named("Mote_REIMU_DelayedSpreadTalisman");
                Mote_REIMU_DelayedSpreadTalisman mote = (Mote_REIMU_DelayedSpreadTalisman)ThingMaker.MakeThing(moteDef);
                ...
                mote.aimDirection = aimDir;
                mote.projectileCount = RealProjectilePerFake;
                mote.spreadAngle = SpreadAngle;
