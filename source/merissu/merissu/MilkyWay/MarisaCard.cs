...
namespace merissu
{
    public class MarisaCard : Ability
    {
        private const float FullPowerCost = 1f;
        public MarisaCard() : base() { }

        public MarisaCard(Pawn pawn, AbilityDef def)
            : base(pawn, def)
        {
        }
        ...
        public override bool Activate(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            HediffDef declareDef = HediffDef.Named("MarisaCardDeclared");
